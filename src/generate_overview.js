...
function main() {
    ...
    const scriptEndIndex = overviewHtml.indexOf(placeholderScriptEnd, scriptStartIndex);
    ...
    if (scriptStartIndex !== -1 && scriptEndIndex !== -1) {
        ...
        const afterScript = overviewHtml.substring(scriptEndIndex + placeholderScriptEnd.length);
